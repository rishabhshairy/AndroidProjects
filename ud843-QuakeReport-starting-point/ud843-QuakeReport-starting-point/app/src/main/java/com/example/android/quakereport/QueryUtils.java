...
/**
 * Created by Rishabh on 1/18/2018.
 */
...
public final class QueryUtils {
     ...
     */
    private static List<Earthquake> extractJsonFeature(String earthquakeJson) {
        ...
        try {
            JSONObject quakeObject=new JSONObject(earthquakeJson);
            JSONArray quakeArray=quakeObject.getJSONArray("features");

            for (int i = 0; i <quakeArray.length() ; i++) {
                JSONObject currentObject=quakeArray.getJSONObject(i);
    ...
    private static String makehttpRequest(URL url) throws IOException {
        ...
        {
            Log.e(LOG_TAG,"Error receiving result");
        }
        finally {
 ...
 public static List<Earthquake> fetchData(String reqUrl)
 {
     ...
     List<Earthquake> earthquakes=extractJsonFeature(jsonResponse);
